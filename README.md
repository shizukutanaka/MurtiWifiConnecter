...
[![Tests](https://img.shields.io/badge/tests-914%20methods-22C55E)](#)
[![i18n](https://img.shields.io/badge/i18n-14%20langs%20%C2%B7%20520%20keys-00C4CC)](#)
...
dotnet test    MWC.sln                    # 914 test methods
```
...
すべて Strings.resx ベース。1ファイル 520 キー × 14 ロケール(+ 中立ベース) = 7,800 エントリ完備。
