...
[![i18n](https://img.shields.io/badge/i18n-14%20langs%20%C2%B7%20532%20keys-00C4CC)](#)
...
mwc privacy --mac-mode hardware   # MAC 追跡のプライバシー勧告(助言のみ)
...
dotnet test    MWC.sln                    # 892 test methods
```
