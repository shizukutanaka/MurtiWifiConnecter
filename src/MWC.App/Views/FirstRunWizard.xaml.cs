...
public partial class FirstRunWizard : Window
{
    ...
    // Read a theme brush from resources; never throw even if the key is absent.
    ...
    private void ShowPage(int idx)
    {
        ...
        // ドット更新 (アクティブ = アクセントカラー、非アクティブ = 非アクティブ前景)
        var dots = new[] { Dot1, Dot2, Dot3 };
        for (int i = 0; i < dots.Length; i++)
            dots[i].Fill = (Brush)(i == idx ? Res("AccentBrush") : Res("FgVeryMutedBrush"));
